...
export default function EditPurchase() {
    ...
    if (id) {
      ...
      if (purchase) {
        setFormData({
          ...
          job_detail: purchase.job_detail,
          qty: purchase.qty,
          unit: purchase.unit,
          price_unit: purchase.price_unit,
          price_shipping: purchase.price_shipping,
          price_admin: purchase.price_admin,
          price_fee: purchase.price_fee,
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    alert('Pembelian berhasil diupdate! (Dummy data)');
  ...
  return (
    <Layout>
      <div className="mb-6">
        ...
        <h1 className="text-3xl font-bold text-gray-800">Edit Pembelian</h1>
        <p className="text-gray-600 mt-1">PO Number: <span className="font-bold text-blue-600">{formData.po_number}</span></p>
      </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-3">
              <button
                type="submit"
                className="w-full px-4 py-3 bg-green-600 text-white rounded-lg hover:bg-green-700 font-bold text-lg shadow-lg"
              >
                💾 Update Pembelian
              </button>
              <Link
