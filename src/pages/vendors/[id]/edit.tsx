...
import { getVendorById } from '@/services/dummy';
...
export default function VendorEdit() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    console.log('Update vendor data:', formData);
  ...
  return (
    <Layout>
      <div className="mb-6">
        ...
        <p className="text-gray-600 mt-1">Perbarui informasi vendor</p>
      </div>
      ...
      <div className="mt-6 bg-yellow-50 border border-yellow-200 rounded-lg p-4">
        <p className="text-sm text-yellow-800">
          <span className="font-bold">⚠️ Perhatian:</span> Perubahan data vendor akan mempengaruhi transaksi pembelian yang terkait dengan vendor ini.
        </p>
      </div>
    </Layout>
  );
